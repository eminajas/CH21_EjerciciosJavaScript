...
function numeroMax(elemento ,index) {
    ...
    console.log(max);
}//codigo para obtener el numero maximo de un arreglo
...
function numeroMin(elemento ,index) {
    ...
    console.log(max);
}//codigo para obtener el numero minimo de un arreglo
...
}//fincion para encontrar numeros iguales en un arreglo
